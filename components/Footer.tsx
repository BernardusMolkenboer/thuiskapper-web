...
const locations = [
  { label: "Amsterdam", href: "/thuiskapper-amsterdam" },
  { label: "Rotterdam", href: "/thuiskapper-rotterdam" },
  { label: "Den Haag", href: "/thuiskapper-den-haag" },
  { label: "Utrecht", href: "/thuiskapper-utrecht" },
  { label: "Eindhoven", href: "/thuiskapper-eindhoven" },
  { label: "Tilburg", href: "/thuiskapper-tilburg" },
  { label: "Groningen", href: "/thuiskapper-groningen" },
  { label: "Almere", href: "/thuiskapper-almere" },
  { label: "Breda", href: "/thuiskapper-breda" },
  { label: "Nijmegen", href: "/thuiskapper-nijmegen" },
];
...
const legalLinks = [
  ...
  { label: "Vraag & antwoord", href: "/vraag-en-antwoord" },
  { label: "Werkgebied", href: "/locaties" },
  { label: "Account verwijderen", href: "/account-verwijderen" },
];
...
const siteLinks = [
  ...
  { label: "Voor kappers", href: "/#kappers" },
    ...
    >
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-12 items-center">
            <div className="text-center lg:text-left">
              ...
              <p className="text-gray-400 text-sm sm:text-lg">
                Ontvang updates, tips en aanbiedingen. (U kunt zich altijd
                afmelden.)
              </p>
            </div>
        ...
        <div className="py-10 sm:py-16">
          {/* ✅ change to lg:grid-cols-6 so Contact stays on the same row */}
          <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-6 gap-8 sm:gap-12">
            ...
            <div className="col-span-2 lg:col-span-2">
              ...
              <p className="text-gray-400 mb-5 sm:mb-8 leading-relaxed text-sm sm:text-base">
                Altijd een kapper bij jou thuis. Professionele
                kapsalon-kwaliteit, waar en wanneer jij wilt.
              </p>

              {/* Socials (keep placeholder URLs if needed) */}
              <div className="flex gap-2.5 sm:gap-3" aria-label="Social media">
                {[
                  {
                    name: "Facebook",
                    href: "https://www.facebook.com/ThuisKapperApp",
                    icon: "M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z",
                  },
                  {
                    name: "Instagram",
                    href: "https://www.instagram.com/thuiskapper_app/",
                  ...
                  {
                    name: "LinkedIn",
                    href: "https://nl.linkedin.com/company/thuiskapper",
            ...
            {/* Contact (fits in the 6th column on lg) */}
